    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/') }}">
                ...
                @if(anlutro\LaravelSettings\Facade::get(\Modules\Platform\Core\Helper\SettingsHelper::S_DISPLAY_SHOW_LOGO_IN_APPLICATION))
                    {!!   \Modules\Platform\Core\Helper\SettingsHelper::displayLogo() !!}
                @else
                    {{ anlutro\LaravelSettings\Facade::get(\Modules\Platform\Core\Helper\SettingsHelper::S_DISPLAY_APPLICATION_NAME, config('app.name'))}}
                @endif
            </a>
