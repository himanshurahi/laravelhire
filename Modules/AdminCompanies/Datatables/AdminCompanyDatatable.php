...
namespace Modules\AdminCompanies\Datatables;
...
class AdminCompanyDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'admincompanies.admincompanies.show';
     ...
     */
    public function query(AdminCompany $model)
    {
    ...
    protected function getColumns()
    {
        return
            [
                'company_name' => [
                    'data' => 'company_name',
                    'title' => trans('admincompanies::admincompanies.table.company_name'),
                    'data_type' => 'text'
                ],
                'created_at' => [
                    'data' => 'created_at',
