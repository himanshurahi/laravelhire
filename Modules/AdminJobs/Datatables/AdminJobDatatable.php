...
namespace Modules\AdminJobs\Datatables;
...
class AdminJobDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'adminjobs.adminjobs.show';
     ...
     */
    public function query(AdminJob $model)
    {
    ...
    protected function getColumns()
    {
        return
            [
                'job_title' => [
                    'data' => 'job_title',
                    'title' => trans('adminjobs::adminjobs.table.job_title'),
                    'data_type' => 'text'
                ],
                'created_at' => [
                    'data' => 'created_at',
