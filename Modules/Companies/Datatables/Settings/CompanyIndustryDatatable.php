...
class CompanyIndustryDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'companies.companyindustry.show';
     ...
     */
    public function query(CompanyIndustry $model)
    {
