...
namespace Modules\Developers\Datatables;
...
class DeveloperDatatable extends PlatformDataTable
{

    const SHOW_URL_ROUTE = 'developers.developers.show';
    ...
    protected function getColumns()
    {
        return
            [
                'first_name' => [
                    'data' => 'first_name',
                    'title' => trans('developers::developers.table.first_name'),
                    'data_type' => 'text'
                ],
                'created_at' => [
                    'data' => 'created_at',
